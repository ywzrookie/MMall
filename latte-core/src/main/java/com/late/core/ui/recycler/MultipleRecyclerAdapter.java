...
import com.late.core.ui.banner.BannerCreator;
 ...
 * Describe:
 */
public class MultipleRecyclerAdapter extends BaseMultiItemQuickAdapter<MultipleItemBean, MultipleViewHolder>
     ...
     */
    @Override
    protected void convert(MultipleViewHolder holder, MultipleItemBean bean) {
        final String text;
